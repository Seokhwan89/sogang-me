  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href={`${b}/posts/new`} className="card p-5 bg-sg-ink text-white"><p className="eyebrow !text-white/60">빠른 작업</p><p className="mt-2 font-semibold">+ 새 게시글 작성</p></Link>
      </div>
