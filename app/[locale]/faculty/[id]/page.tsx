...
export default async function FacultyDetail({ params }: { params: { locale: Locale; id: string } }) {
  ...
  return (<>
    ...
    <div className="container-site py-14 grid lg:grid-cols-[300px_1fr] gap-12">
      <aside>
        <div className="aspect-[3/4] bg-sg-mist overflow-hidden">{f.photo_url && <img src={f.photo_url} alt="" className="w-full h-full object-cover" />}</div>
